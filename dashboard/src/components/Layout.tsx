...
const PAGE_META = [
  ...
  { match: (path: string) => path === '/account', title: '账户管理', eyebrow: 'tenant', lede: '租户、用户、团队、API key、配额和审计。' },
  { match: (path: string) => path === '/settings', title: '全局设置', eyebrow: 'settings', lede: '供应商、会话、限制和工具默认配置。' },
  ...
  { match: (path: string) => path === '/skills', title: '技能背包', eyebrow: 'skills', lede: '从 GitHub 或本地路径导入技能。' },
